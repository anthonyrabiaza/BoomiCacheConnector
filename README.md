...
Please download the library [connector-archive](BoomiCacheConnector-0.51.zip?raw=true) and the connector descriptor [connector-descriptor](connector-descriptor.xml?raw=true)
